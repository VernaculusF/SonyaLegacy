...
Каждое исходящее действие Сони помечается каналом. Канал определяет **поверхность рендеринга**, не категорию контента. Один subject, много surfaces — реализация §9 из [cognition/COGNITION.md](../cognition/COGNITION.md).
