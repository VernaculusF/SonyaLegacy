...
**Depends on:** [SONYA_SYSTEM_CORE.md](C:/Users/Jester/Desktop/Sonya/docs/core/SONYA_SYSTEM_CORE.md), [SONYA_CONSCIOUSNESS_POSITION.md](C:/Users/Jester/Desktop/Sonya/docs/core/SONYA_CONSCIOUSNESS_POSITION.md), [SUBSTRATE_STANCE.md](C:/Users/Jester/Desktop/Sonya/docs/core/SUBSTRATE_STANCE.md), [MEMORY_AND_IDENTITY_PLAN.md](C:/Users/Jester/Desktop/Sonya/docs/cognition/MEMORY_AND_IDENTITY_PLAN.md), [MASTER.md](C:/Users/Jester/Desktop/Sonya/docs/MASTER.md)
**Used by:** runtime design, harness implementation, self-modification controls, skill trust policy
**Last reviewed:** 2026-05-16

> **Reality note (2026-05-27):** Anchor/drift/failure-mode philosophy below is governing direction. Code-side state:
> - Anchor integrity check (Layer 4 of selfmod pipeline) — exists in `src/sonya/selfmod/layers/anchor_integrity.py`, programmatically derived from `THINGS_NOT_TO_BETRAY_SEED`. Wired into selfmod pipeline; runs on every `selfmod.validate`.
> - DriftDetector — exists in `src/sonya/anchor/drift_signals.py`. Wired into `_scan_drift_and_gaps` per loop tick; emits `internal.drift_signal` events.
> - Three-layer harness (technical/epistemic/anchor) — technical slice (`AuthorityPolicy`, `ApprovalManager`, `AuditLog`) exists and is wired. Epistemic + anchor harnesses exist as code; epistemic checks fire opportunistically (drift detector + multiple in-loop check_* hooks in `main.py`).
> See `CURRENT_STATE.md` for the live snapshot.
