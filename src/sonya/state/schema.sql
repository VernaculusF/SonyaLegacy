...
CREATE TABLE IF NOT EXISTS subject_state (
    ...
    -- v20 (Atrium В¦РЅTР’В¦-В¦В¬ 0): Sonya-controlled state surfaces.
    ...
    -- for Avatar / Room view rendering. В¦Р±В¦-. docs/atrium/EVENT_SCHEMA.md TР·1.2.
...
CREATE TABLE IF NOT EXISTS continuity_events (
    ...
    -- v20 (Atrium В¦РЅTР’В¦-В¦В¬ 0): channel + private fields (mirror payload values
    -- to dedicated columns for SQL-level filtering В¦-В¦В¦В¦В¬ В¦В¬В¦-TРђTР‘В¦В¬В¦-В¦В¦В¦- JSON).
    -- channel: 'dialog' | 'worker_log' | 'mind' | 'body' | 'voice' | ''
    -- private=1: skipped from /atrium/feed but kept in substrate.
    -- В¦Р±В¦-. docs/atrium/EVENT_SCHEMA.md TР·1.1.
...
-- yet С‚РђР¤ index creation TР’В¦-В¦- would fail on `no such column`).
...
-- Relation anchor bindings: identity-critical (per SUBSTRATE_STANCE TР·8).
...
-- See [docs/SYSTEM_BUILDOUT_PLAN.md] В¦РЅTР’В¦-В¦В¬ C.
-- ====================================================================
...
-- See [docs/SYSTEM_BUILDOUT_PLAN.md] post-В¦РЅTР’В¦-В¦В¬ cleanup.
-- ====================================================================
...
-- These columns added via ALTER TABLE in migration v8 С‚Р–Рў v9.
-- ====================================================================
...
-- tool. Examples: ivan_status='TР‘В¦В¬В¦В¬TР’', activity='TРђВ¦-В¦-В¦-TР’В¦-В¦В¦TР’ В¦-В¦-В¦+ В¦В¬В¦-TРђTР‘В¦В¦TРђВ¦-В¦-',
-- mood='TР“TР‘TР’В¦-В¦-TР�В¦В¬В¦В¦'. No clock heuristics С‚РђР¤ she infers from conversation.
-- ====================================================================
