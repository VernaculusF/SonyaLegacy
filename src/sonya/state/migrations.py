...
def ensure_critical_schema(conn: sqlite3.Connection) -> None:
    ...
    _add_column_if_missing(conn, "provider_settings", "default_fallback", "TEXT NOT NULL DEFAULT ''")
    _add_column_if_missing(conn, "provider_settings", "fast_fallback", "TEXT NOT NULL DEFAULT ''")
    _add_column_if_missing(conn, "provider_settings", "deep_fallback", "TEXT NOT NULL DEFAULT ''")
    _add_column_if_missing(conn, "provider_settings", "vision_fallback", "TEXT NOT NULL DEFAULT ''")
